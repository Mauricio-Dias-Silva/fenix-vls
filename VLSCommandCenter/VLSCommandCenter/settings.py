"""
Django settings for VLSCommandCenter project.
...
# SECURITY: Key is read from environment in production; fallback is for local dev only
...
ROOT_URLCONF = 'VLSCommandCenter.urls'
...
WSGI_APPLICATION = 'VLSCommandCenter.wsgi.application'
